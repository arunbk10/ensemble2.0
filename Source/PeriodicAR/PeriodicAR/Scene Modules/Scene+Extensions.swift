...
//  ARLocationTRacker
//
//  Created by Sharanabasappa-Macmini on 20/07/18.
...
extension SCNVector3
{
    ...
    static func positionFromTransform(_ transform: SCNMatrix4) -> SCNVector3 {
        return SCNVector3Make(transform.m41, transform.m42, transform.m43)
    }
    ...
    func distance(from vector: SCNVector3) -> Float {
        ...
        let distance = Float(sqrt(distanceX * distanceX + distanceY * distanceY + distanceZ * distanceZ))
    ...
    func line(to vector: SCNVector3, color: UIColor = UIColor.blue) -> SCNNode {
    ...
    func getCGpointFromScnVector3() -> CGPoint {
        return CGPoint(x:  CGFloat(self.x), y: CGFloat(self.z))//CGPoint(x:, y: self.z)
    }
}
